...
- 以色列是停留在條件式報復、實際還擊，或轉為主動介入
- 胡塞是否把壓力擴至曼德海峽／紅海，進而影響蘇伊士航運
- 伊朗與代理人是否用機動發射、分散部署、無人機／無人艇延長抵抗
- 官方發布、多方報導與單一來源的可信度標記
- 報導中的實際後果、海上壓力、能力衰退與持續反擊訊號
- Brent 原油、S&P 500、台股、VIX 與黃金
- 三種終局路徑：伊朗較弱、伊朗較強、中間僵局
- 每日終局推演：今天揭露了什麼、仍不知道什麼、美方可能如何修正認知、較接近哪條終局路徑
- 三條對稱路徑：A 伊朗底牌有限而被迫談、B 伊朗持續施壓而迫使美方接受限制、C 雙方都想再測一次而陷入僵局
- 明確列出協議執行力、結論的推翻條件，以及擴大戰事既可能製造答案也可能製造僵局的雙面作用

所有自動計數都是「公開證據項目」，不是攻擊、飛彈、無人機或攔截次數，也不是情境機率。
條件式報復言論不會直接算成以色列參戰，分析員對第二航運咽喉的警告也不會直接算成紅海或蘇伊士已被封鎖。
新聞數量不再直接選出終局情境；系統先分開「仍能造成損害」、「能否跨窗持續」、「是否迫使對手修正目標」與「能否形成可執行協議」四個命題。
