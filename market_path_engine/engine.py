    ...
    payload: dict[str, Any] = {
        ...
        "methodology": {
            ...
            "regime_weights": {
                ...
                "liquidity_drain": 0.18,
                "volatility": 0.22,
                "positioning_defense": 0.14,
                "cross_asset_defense": 0.16,
                "event_shock": 0.08,
            },
            "path_probability_inputs": ["regime_stress", "liquidity", "event_shock"],
            "external_site_policy": {
                "catalog": "https://kidd0368.github.io/github/catalog.json",
                "direct_weight": False,
                "core_signal": "confirmation_or_contradiction_only",
                "conditional_module": "activate_only_when_triggered",
                "research_only": "context_only",
                "new_site_default": "research_only",
            },
